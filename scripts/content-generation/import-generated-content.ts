...
async function importPieceIntroductions() {
  console.log('📚 Importing piece introductions...');
  ...
  console.log(`✓ Updated ${updated} piece introductions`);
}

async function importFeatures() {
  console.log('🎵 Importing feature definitions...');
  ...
  console.log(`✓ Created ${created} features, updated ${updated} features`);
}

async function importCurriculumLessons() {
  console.log('📖 Importing curriculum lessons...');
  ...
  console.log(`✓ Imported ${created} curriculum lessons`);
}

async function importMeasureCommentary() {
  console.log('📝 Importing BWV 846 measure commentary...');
  ...
  console.log(`✓ Imported ${created} measure commentaries`);
}

async function main() {
  console.log('🚀 Starting content import from generated files...\n');
